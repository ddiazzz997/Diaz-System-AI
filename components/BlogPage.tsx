          ...
          <div className="max-w-7xl mx-auto relative z-10">
            <div className="text-center max-w-3xl mx-auto mb-12">
              <h1 className="text-5xl md:text-6xl font-bold text-white mb-6">
                Insights y <span className="text-transparent bg-clip-text bg-gradient-to-r from-logo-cyan via-logo-purple to-logo-deep">Estrategias</span>
              </h1>
              <p className="text-xl text-gray-400">
                Insights expertos sobre el crecimiento en LinkedIn, generación de leads B2B y escalamiento de tu negocio de consultoría más allá de $50k/mes.
              </p>
            </div>
          ...
          <div className="max-w-7xl mx-auto">
            {filteredArticles.length === 0 ? (
              <div className="text-center py-20">
                <p className="text-gray-400 text-lg">No se encontraron artículos. Intenta ajustar tus filtros.</p>
              </div>
            ) : (
              <>
                {/* Featured Article */}
                    ...
                    <div className="grid md:grid-cols-2 gap-0">
                      <div className="p-8 md:p-12 flex flex-col justify-center">
                        <div className="flex items-center gap-3 mb-4">
                          ...
                          <span className="text-gray-500 text-sm">Destacado</span>
                        </div>
        ...
        <section className="px-6 pb-20">
          <div className="max-w-7xl mx-auto">
            <div className="glass-panel rounded-2xl p-8 border border-white/10">
              <h3 className="text-white font-bold text-xl mb-4">Explorar por Tema</h3>
